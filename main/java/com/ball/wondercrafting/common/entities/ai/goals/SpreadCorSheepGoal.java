package com.ball.wondercrafting.common.entities.ai.goals;
...
public class SpreadCorSheepGoal extends Goal {
    ...
    public SpreadCorSheepGoal(MobEntity grassEaterEntityIn) {
            ...
            if (IS_GRASS.test(this.entityWorld.getBlockState(blockpos))) {
                ...
                if (this.entityWorld.getBlockState(blockpos1).isIn(Blocks.GRASS_BLOCK)) {
                    if (net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.entityWorld, this.grassEaterEntity)) {
                        ...
                        this.entityWorld.setBlockState(blockpos1, BlockInit.CORDIRT.get().getDefaultState(), 2);
                    }
