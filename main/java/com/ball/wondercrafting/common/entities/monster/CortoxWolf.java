...
public class CortoxWolf extends CreatureEntity {
    public CortoxWolf(EntityType<? extends CortoxWolf> type, World worldIn){
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new CortoxWolf.AttackGoal(this));
    ...
    public static AttributeModifierMap.MutableAttribute func_234215_eI_() {
        return MobEntity.func_233666_p_().createMutableAttribute(Attributes.FOLLOW_RANGE, 35.0D)
                .createMutableAttribute(Attributes.MAX_HEALTH, 8.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.3D)
                .createMutableAttribute(Attributes.ATTACK_DAMAGE, 2.5D);
    }

    static class AttackGoal extends MeleeAttackGoal {
        public AttackGoal(CortoxWolf wolf) {
