...
public class WarpedCrateFeature extends Feature<ProbabilityConfig> {
    private static final BlockState CRATE = BlockInit.WARPED_CRATE.get().getDefaultState();

    public WarpedCrateFeature(Codec<ProbabilityConfig> codec) {
        super(codec);
    }
